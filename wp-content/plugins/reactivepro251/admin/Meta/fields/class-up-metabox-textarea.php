...
class Re_Meta_Generator_textarea
{
	public $post_id;
	public $type;
	public $field;
		...
		<div class="row meta-single-content">
			...
			<div class="col-xs-8 up_meta_tail">
				...
				<?php if( $this->type == 'linear'): ?>
					<textarea type="text" name="<?php echo esc_attr( $meta_key );  ?>"  class="form-control" placeholder="<?php echo esc_attr( $placeholder );  ?>" ><?php echo esc_attr( $grabbed_value );  ?></textarea>
									...
									<?php foreach ($grabbed_value as $key => $item ) {   ?>
										...
										<div class="up-repeat">
											<div class="row pt6">
												...
												<div class="col-xs-10">
													<textarea type="text" name="<?php echo esc_attr( $meta_key ); ?>[]"  class="rq-form-control repeat-input" placeholder="<?php echo esc_attr( $placeholder );  ?>"><?php echo esc_attr( $item );  ?></textarea>
													<br/>
												</div>
												<div class="col-xs-1 pt6">
						...
						<?php 	}else{	?>
								...
								<div class="up-repeat">
									<div class="row pt6">
										...
										<div class="col-xs-10">
											<textarea type="text" name="<?php echo esc_attr( $meta_key ); ?>[]"  class="rq-form-control" placeholder="<?php echo esc_attr( $placeholder );  ?>"  ></textarea>
											<br>
										</div>
										<div class="col-xs-1 pt6">
											<a class="remove-row" href="#"><span class="glyphicon glyphicon-remove option_cross"></a>
				...
				<?php if( $this->type == 'repeatBundle'): ?>
					<div class="row">
						<div class="col-xs-10">
							<textarea type="text" name="<?php echo esc_attr( $meta_key ); ?>[]"  class="form-control" placeholder="<?php echo esc_attr( $placeholder );  ?>"><?php echo esc_attr( $this->load );  ?></textarea>
							<br>
						</div>
					</div>
				<?php endif; ?>
